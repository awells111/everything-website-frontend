...
export type GetPokemonByTypeQuery = { __typename?: 'Query', pokemonByType: Array<{ __typename?: 'Pokemon', id: string, name: string, sprites: { __typename?: 'PokemonSprites', frontDefault?: string | null } }> };
